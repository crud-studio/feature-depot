...
public class DoubleMetaphoneAlgo implements StringEncoder {
    ...
    private int maxCodeLen = 16;

    public DoubleMetaphoneAlgo() {
    }
    ...
    public String doubleMetaphone(String value, boolean alternate) {
        ...
        if (value == null) {
            ...
            DoubleMetaphoneAlgo.DoubleMetaphoneResult result = new DoubleMetaphoneAlgo.DoubleMetaphoneResult(this.getMaxCodeLen());
    ...
    private int handleAEIOUY(DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
        if (index == 0) {
            result.append('A');
        }
    ...
    private int handleC(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleCC(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleCH(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleD(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleG(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
    ...
    private int handleGH(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleH(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleJ(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
    ...
    private int handleL(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleP(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
        if (this.charAt(value, index + 1) == 'H') {
            result.append('F');
            index += 2;
        } else {
    ...
    private int handleR(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
    ...
    private int handleS(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
    ...
    private int handleSC(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleT(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleW(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
    ...
    private int handleX(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index) {
        if (index == 0) {
            result.append('S');
            ++index;
        } else {
    ...
    private int handleZ(String value, DoubleMetaphoneAlgo.DoubleMetaphoneResult result, int index, boolean slavoGermanic) {
        if (this.charAt(value, index + 1) == 'H') {
            result.append('J');
            index += 2;
        } else {
    ...
    public class DoubleMetaphoneResult {
        private final StringBuilder primary = new StringBuilder(DoubleMetaphoneAlgo.this.getMaxCodeLen());
        private final StringBuilder alternate = new StringBuilder(DoubleMetaphoneAlgo.this.getMaxCodeLen());
